...
@Path("/restituicao-ferias")

public class FeriasController {

    @GET
    @Path("/getFeriasRestituidas/{codigoContrato}/{codigoUsuario}")
    @Produces(MediaType.APPLICATION_JSON)

    public Response getFeriasRestituidas (@PathParam("codigoContrato") int codigoContrato, @PathParam("codigoUsuario") int codigoUsuario) {
