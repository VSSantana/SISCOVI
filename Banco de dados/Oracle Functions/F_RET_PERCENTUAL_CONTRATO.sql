create or replace function "F_RET_PERCENTUAL_CONTRATO" (pCodContrato NUMBER, pCodRubrica NUMBER, pDataInicio DATE, pDataFim DATE, pRetroatividade NUMBER) RETURN FLOAT
IS
